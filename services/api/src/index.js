...
const paymentMethodsRoutes = require('./modules/paymentMethods/routes');
const { router: paymentProvidersRoutes } = require('./modules/paymentProviders/routes');
...
const quoteRequestsRoutes = require('./modules/quote-requests/routes');
const deliveryRulesRoutes = require('./modules/deliveryRules/routes');
...
const { startScheduledDelayCheck } = require('./modules/shipmentDelayCheck/check');
...
app.use('/payment-providers', paymentProvidersRoutes);
...
app.use('/notifications', pushRoutes);
...
app.use('/delivery-rules', deliveryRulesRoutes);
...
if (require.main === module) {
  ...
  // Real, once-a-day shipment-delay check (#57) -- same real startup
  // guard as above.
  startScheduledDelayCheck();
}
