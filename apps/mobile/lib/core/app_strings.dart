...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _strings = {
    ...
    'cart_removed_from_cart': {'en': 'removed from cart', 'ar': 'تمت إزالته من السلة'},
    ...
    'change_email': {'en': 'Change email', 'ar': 'تغيير البريد الإلكتروني'},
    'current_email_label': {'en': 'Current email:', 'ar': 'البريد الإلكتروني الحالي:'},
    'new_email_label': {'en': 'New email', 'ar': 'البريد الإلكتروني الجديد'},
    'current_password_label': {'en': 'Current password', 'ar': 'كلمة المرور الحالية'},
    'save_changes': {'en': 'Save changes', 'ar': 'حفظ التغييرات'},
    'email_changed_success': {'en': 'Your email has been updated.', 'ar': 'تم تحديث بريدك الإلكتروني.'},
    'please_fill_all_fields': {'en': 'Please fill in all fields.', 'ar': 'يرجى ملء جميع الحقول.'},
    ...
    'track_an_order': {'en': 'Track an order', 'ar': 'تتبع طلب'},
    'track_order_hint': {'en': 'Enter your order ID (from your confirmation) and the email you used to place it.', 'ar': 'أدخل رقم الطلب (من رسالة التأكيد) والبريد الإلكتروني الذي استخدمته لتقديمه.'},
    ...
    'address_set_as_default_message': {'en': 'Set as your default address', 'ar': 'تم تعيينه كعنوانك الافتراضي'},
    'address_already_default_message': {'en': 'This is already your default address', 'ar': 'هذا هو عنوانك الافتراضي بالفعل'},
    ...
    'search_for_address_hint': {'en': 'Search for your address (optional)', 'ar': 'إبحث عن عنوانك (إختياري)'},
    'compare_label': {'en': 'Compare', 'ar': 'مقارنة'},
    'two_factor_title': {'en': 'Two-factor authentication', 'ar': 'المصادقة الثنائية'},
    'two_factor_description': {
      'en': 'Add an extra layer of security. Once turned on, you\'ll need a code from your authenticator app (like Google Authenticator or Authy) every time you log in, in addition to your password.',
      'ar': 'أضف طبقة إضافية من الأمان. بمجرد التفعيل، ستحتاج إلى رمز من تطبيق المصادقة الخاص بك (مثل Google Authenticator أو Authy) في كل مرة تسجل فيها الدخول، بالإضافة إلى كلمة المرور.',
    },
    'two_factor_turn_on': {'en': 'Turn on two-factor authentication', 'ar': 'تفعيل المصادقة الثنائية'},
    'two_factor_scan_qr': {'en': 'Scan this code with your authenticator app:', 'ar': 'امسح هذا الرمز باستخدام تطبيق المصادقة الخاص بك:'},
    'two_factor_manual_key': {'en': 'Or enter this key manually:', 'ar': 'أو أدخل هذا المفتاح يدويًا:'},
    'two_factor_enter_code': {'en': 'Then enter the 6-digit code it shows:', 'ar': 'ثم أدخل الرمز المكون من 6 أرقام الذي يظهر:'},
    'two_factor_confirm_turn_on': {'en': 'Confirm and turn on', 'ar': 'تأكيد وتفعيل'},
    'two_factor_now_on': {'en': 'Two-factor authentication is now on.', 'ar': 'تم تفعيل المصادقة الثنائية الآن.'},
    'two_factor_now_off': {'en': 'Two-factor authentication is now off.', 'ar': 'تم إيقاف المصادقة الثنائية الآن.'},
    'two_factor_is_on': {'en': 'Two-factor authentication is on.', 'ar': 'المصادقة الثنائية مفعّلة.'},
    'two_factor_enter_password_to_disable': {'en': 'Enter your current password to turn it off:', 'ar': 'أدخل كلمة المرور الحالية لإيقافها:'},
    'current_password_field': {'en': 'Current password', 'ar': 'كلمة المرور الحالية'},
    'two_factor_turn_off': {'en': 'Turn off two-factor authentication', 'ar': 'إيقاف المصادقة الثنائية'},
    'report_bug_title': {'en': 'Report a bug', 'ar': 'الإبلاغ عن مشكلة'},
    'report_bug_what_happened': {'en': 'What happened?', 'ar': 'ماذا حدث؟'},
    'report_bug_description_hint': {'en': 'Describe what you were doing and what went wrong...', 'ar': 'صف ما كنت تفعله وما الذي حدث بشكل خاطئ...'},
    'report_bug_attach_screenshot': {'en': 'Attach a screenshot (optional)', 'ar': 'إرفاق لقطة شاشة (إختياري)'},
    'report_bug_screenshot_attached': {'en': 'Screenshot attached ✓', 'ar': 'تم إرفاق لقطة الشاشة ✓'},
    'report_bug_submit_error': {'en': 'Could not submit your report. Please try again.', 'ar': 'تعذر إرسال بلاغك. يرجى المحاولة مرة أخرى.'},
    'report_bug_submit': {'en': 'Submit report', 'ar': 'إرسال البلاغ'},
    'choose_a_brand': {'en': 'Choose a brand', 'ar': 'اختر العلامة التجارية'},
    'choose_a_model': {'en': 'Choose a model', 'ar': 'اختر الموديل'},
    'choose_a_generation': {'en': 'Choose a generation', 'ar': 'اختر الجيل'},
    'choose_a_year': {'en': 'Choose a year', 'ar': 'اختر السنة'},
    'enter_your_vin': {'en': 'Enter your VIN', 'ar': 'أدخل رقم الهيكل (VIN)'},
    'vin_hint': {'en': '17-character VIN', 'ar': 'رقم الهيكل المكون من 17 حرفًا'},
    'look_up_button': {'en': 'Look up', 'ar': 'بحث'},
    'could_not_load_error': {'en': 'Could not load', 'ar': 'تعذر التحميل'},
    'nothing_here_yet': {'en': 'Nothing here yet.', 'ar': 'لا يوجد شيء هنا بعد.'},
    'any_year_in_generation': {'en': 'Any year in this generation', 'ar': 'أي سنة ضمن هذا الجيل'},
    'have_vin_look_up': {'en': 'Have your VIN? Look it up instead', 'ar': 'هل لديك رقم الهيكل (VIN)؟ ابحث به بدلاً من ذلك'},
    'looking_up_vin': {'en': 'Looking up your VIN…', 'ar': 'جارٍ البحث عن رقم الهيكل...'},
    'sort_and_price_title': {'en': 'Sort & price', 'ar': 'الترتيب والسعر'},
    'sort_by_label': {'en': 'Sort by', 'ar': 'الترتيب حسب'},
    'relevance_label': {'en': 'Relevance', 'ar': 'الأكثر صلة'},
    'price_low_to_high': {'en': 'Price: Low to High', 'ar': 'السعر: من الأقل إلى الأعلى'},
    'price_high_to_low': {'en': 'Price: High to Low', 'ar': 'السعر: من الأعلى إلى الأقل'},
    'newest_label': {'en': 'Newest', 'ar': 'الأحدث'},
    'price_range_label': {'en': 'Price range', 'ar': 'نطاق السعر'},
    'min_field': {'en': 'Min', 'ar': 'الحد الأدنى'},
    'max_field': {'en': 'Max', 'ar': 'الحد الأقصى'},
    'delivery_speed_label': {'en': 'Delivery speed', 'ar': 'سرعة التوصيل'},
    'delivery_any': {'en': 'Any', 'ar': 'أي وقت'},
    'within_3_days': {'en': 'Within 3 days', 'ar': 'خلال 3 أيام'},
    ...
    'contact_us_label': {'en': 'Contact us', 'ar': 'تواصل معنا'},
    'two_factor_auth_label': {'en': 'Two-factor authentication', 'ar': 'المصادقة الثنائية'},
    'delete_account_label': {'en': 'Delete account', 'ar': 'حذف الحساب'},
    'delete_account_confirm_title': {'en': 'Delete your account?', 'ar': 'حذف حسابك؟'},
    'delete_account_confirm_body': {
      'en': 'This permanently removes your personal info. Your order history stays for our records, but is no longer tied to your name or email.',
      'ar': 'سيؤدي هذا إلى إزالة معلوماتك الشخصية بشكل نهائي. يبقى سجل طلباتك لدينا، لكن لن يكون مرتبطًا باسمك أو بريدك الإلكتروني بعد الآن.',
    },
    'continue_label': {'en': 'Continue', 'ar': 'متابعة'},
    'confirm_password_title': {'en': 'Confirm your password', 'ar': 'تأكيد كلمة المرور'},
    'password_field': {'en': 'Password', 'ar': 'كلمة المرور'},
    'incorrect_password_error': {'en': 'Incorrect password', 'ar': 'كلمة المرور غير صحيحة'},
    ...
    'system_default': {'en': 'System', 'ar': 'النظام'},
    ...
    'total_tickets': {'en': 'Total tickets', 'ar': 'إجمالي التذاكر'},
